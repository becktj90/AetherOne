# AetherSense — Web Dashboard

A hosted PWA that displays real-time air quality data from your AetherSense device. Access it from any browser — phone, tablet, or work laptop — over public HTTPS.
